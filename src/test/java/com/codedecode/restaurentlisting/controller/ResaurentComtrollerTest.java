...
public class ResaurentComtrollerTest {


    @InjectMocks
    ResaurentComtroller restaurantController;
    ...
    public void testFetchAllRestaurants(){
        ...
        List<RestaurentDTO> mockRestaurants = Arrays.asList(
                new RestaurentDTO(1, "Restaurant 1", "Address 1", "city 1", "Desc 1"),
                new RestaurentDTO(2, "Restaurant 2", "Address 2", "city 2", "Desc 2")
        );
        when(restaurantService.findAllResaurents()).thenReturn(mockRestaurants);

        // Call the controller method
        ResponseEntity<List<RestaurentDTO>> response = restaurantController.fetchallRestaurents();
        ...
        verify(restaurantService, times(1)).findAllResaurents();
    }
